...
from app.services.scheduler_service import start_scheduler, stop_scheduler, setup_signal_handlers
...
def create_app() -> FastAPI:
    ...
    async def startup_event():
        ...
        if not settings.debug:  # Only start scheduler in production
